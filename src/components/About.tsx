        ...
        <div className="grid md:grid-cols-2 gap-16 items-start" ref={ref}>
          ...
          >
            ...
            {about.bio.map((paragraph, i) => (
              <p key={i} className="text-gris-txt/80 text-base md:text-lg leading-relaxed mb-4 last:mb-0">
                {paragraph}
              </p>
            ))}
          </motion.div>
          ...
          >
            <div
              ...
              style={{ background: "linear-gradient(to bottom, #C9A24B, #6B1F3A)" }}
              aria-hidden="true"
            />
            <blockquote className="pl-8">
              ...
              <footer className="text-sm font-semibold text-dorado uppercase tracking-widest">
            ...
            <div
              ...
              style={{ background: "linear-gradient(135deg, #6B1F3A08, #C9A24B12)" }}
            >
              <p className="font-playfair text-vino text-lg font-medium">
                IGA Comunicación Total Consultores
              </p>
              <p className="text-gris-txt/60 text-sm mt-2">
                Consultoría especializada en comunicación, relaciones públicas, protocolo y producción de eventos.
              </p>
            </div>
          </motion.div>
        </div>
